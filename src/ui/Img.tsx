...
export function Source({
  ...
  return <source srcSet={imageProps.srcSet} width={imageProps.width} height={imageProps.height} media={media} {...props} />
}
...
function generateSrc(image: Sanity.Image, w?: number | `${number}` | string, h?: number | `${number}` | string) {
